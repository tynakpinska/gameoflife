      ...
      <div className="footer">
        ...
        <div className={this.state.aboutDisplay ? "info" : "info hide"}>
          <p>
            ...
            <a href="https://zenjaskiniowca.pl/jak-wyrobic-nawyk-wygrywania/">
              Zen Jaskiniowca
            </a>{" "}
          ...
          <p>
            ...
            three main areas (defined by{" "}
            <a href="https://zenjaskiniowca.pl/o-mnie/">Rafał Mazur</a>):{" "}
          </p>
          <ol>
            <li>body shape</li>
            <li>state of mind</li>
          ...
          <p>
            ...
            - you lost. Additionaly, after a busy day, see your stats. Admire
            how hard you worked during a week, a year, and see how far it got
            you. Try it out and see it for yourself!
          </p>
        </div>
        <button onClick={this.handleAboutClick}>{this.state.aboutDisplay ? (<i className="demo-icon icon-down"></i>) : ""}ABOUT</button>
      </div>
    );
  }
}
